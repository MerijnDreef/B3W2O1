...
<h1 id="logo">Mad Libs</h1>
    ...
    <div class="backgroundForm">
        ...
        <p>Er zijn veel mensen die niet kunnen <?=$_POST['vraag1']?>. Neem nou <?=$_POST['vraag2']?>. Zelfs met de hulp van een <?=$_POST['vraag4']?> of zelfs <?=$_POST['vraag3']?> kan <?=$_POST['vraag2']?> niet <?=$_POST['vraag1']?>. Dar heeft niet te maken met een gebrek aan <?=$_POST['vraag5']?>, maar met een te veel aan <?=$_POST['vraag6']?>. Te veel <?=$_POST['vraag6']?> leidt tot <?=$_POST['vraag7']?> en dat is niet goed las je wilt <?=$_POST['vraag1']?>. Helaas voor <?=$_POST['vraag2']?>.</p>
    </div>

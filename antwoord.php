...
<h1 id="logo">Mad Libs</h1>
    ...
    <div class="backgroundForm">
       ...
       <p>Er heerst een paniek in het koninkrijk<?= $_POST['vraag3']?>. Koning <?= $_POST['vraag6']?> is ten einde raad en als koning <?=$_POST['vraag6']?> ten einde raad is, dan roept hij zijn ten-einde-raadsheer <?=$_POST['vraag2']?>.</p>
